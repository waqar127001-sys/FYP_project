          ...
          <div className={styles.cardGrid}>
            {pendingProjects.map((project) => (
              <div key={project._id} className={styles.card}>
                ...
                <p>
                  <strong>Group:</strong> {project.groupId?.subject || "N/A"}
                </p>
                <p>
                  <strong>Supervisor:</strong>{" "}
                  {project.supervisorId?.name || "N/A"}
                </p>
                <p>
                ...
                <div className={styles.buttonGroup}>
                  <button
                    ...
                    onClick={() =>
                      handleDecision(project.projectId._id, "approved")
                    }
                  >
                    Approve
                  </button>
                  <button
                    ...
                    onClick={() =>
                      handleDecision(project.projectId._id, "rejected")
                    }
                  >
                    Reject
                  </button>
